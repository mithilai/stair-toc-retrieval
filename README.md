...
The binding constraint is the number of section titles the model must memorise, not the context length. Every book tested has a table of contents under 2,300 tokens, well inside the paper's 14,000-token budget.
